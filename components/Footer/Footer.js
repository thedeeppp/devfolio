        ...
        <div className="w-full h-full pt-32">
          <div className="section-container flex flex-col h-full justify-end z-10 items-center py-12">
            ...
            <Button
                ...
                classes="link px-6 py-3 rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition-all duration-300"
                type="primary"
              >
                Let&apos;s Talk
              </Button>
              <Button
                href="/resume.pdf"
                classes="link px-6 py-3 rounded-lg bg-gray-600 text-white hover:bg-gray-700 transition-all duration-300"
                type="primary"
                target="_blank"
            ...
            <p className="text-center text-white text-sm sm:text-base font-medium tracking-wide mt-8">
              ...
              by <span className="text-white">Deep Trivedi</span>
            </p>
          </div>
        </div>
      </Fade>
